...
public class DeleteContability {
    private static final Logger LOGGER = Logger.getLogger(DeleteBill.class.getName());

    public void sendDeleteContabilityRequest(ContabilityDTO contabilityDTO) {
        try {

            Long id = contabilityDTO.getIdContabilidad();
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("http://localhost:8080/api/contability/delete/" + id))
                    .DELETE()
                    .build();
