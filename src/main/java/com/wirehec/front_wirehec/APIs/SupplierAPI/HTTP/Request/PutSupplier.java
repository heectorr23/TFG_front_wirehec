...
import com.wirehec.front_wirehec.DTO.Adapters.SupplierDTOTypeAdapter;
...
public class PutSupplier {
    private static final Logger LOGGER = Logger.getLogger(PutSupplier.class.getName());

    public void sendPutSupplierRequest(SupplierDTO supplierDTO, long id) {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create("http://localhost:8080/api/supplier/update/" + id))
