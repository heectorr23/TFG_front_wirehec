...
public class RegisterUserDTOTypeAdapter extends TypeAdapter<RegisterUserDTO> {
    @Override
    public void write(JsonWriter out, RegisterUserDTO value) throws IOException {
        out.beginObject();
    ...
    @Override
    public RegisterUserDTO read(JsonReader in) throws IOException {
        return null;
    }
}
